import { Bell, HelpCircle, Sun, Moon, Gift, AlertCircle, CheckCircle, ExternalLink } from "lucide-react";
...
const Header = () => {
    ...
    return (
        <header className="h-14 border-b border-white/10 flex items-center justify-end px-6" style={{ backgroundColor: "#1F1F1E" }}>
            <div className="flex items-center gap-3">
                <div className="flex items-center gap-0.5 border border-white/10 p-0.5" style={{ borderRadius: "6px" }}>
                    <button 
                        ...
                        style={isDark ? { backgroundColor: "#40413F", borderRadius: "4px" } : {}}
                    >
                        <Moon size={13} />
                    </button>
                    <button 
                                        ...
                                        notifications.map((notification) => (
                                            ...
                                            >
                                                <div className="flex items-start justify-between gap-2 mb-1">
                                                    ...
                                                    {!notification.read && (
                                                        <span className="w-1.5 h-1.5 rounded-full flex-shrink-0 mt-1" style={{ backgroundColor: "#E0FE58" }}></span>
                                                    )}
                                                </div>
