    ...
    return (
        <aside className="w-64 h-screen flex flex-col border-r border-surface-light bg-surface">
            ...
            <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                <Link
                    to="/app/home"
                    className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-white/60 hover:text-white hover:bg-surface-light transition-colors duration-200 bg-surface-light/50 mb-3"
                >
                ...
                {navLinks.map((link) => {
                    ...
                    return (
                        <Link
                            ...
                            style={location.pathname === link.path ? { backgroundColor: "var(--color-surface-light)" } : {}}
                        >
