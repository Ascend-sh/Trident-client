            ...
            {[1, 2, 3].map((step) => (
                <div 
                    ...
                    className={`h-0.5 flex-1 rounded-full transition-colors duration-300 ${
                        step <= currentStep ? 'bg-brand' : 'bg-brand/10'
                    }`}
                />
            ))}
        </div>
                                    ...
                                    {PRESET_AMOUNTS.map((amt) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`h-9 rounded-md text-[11px] font-bold transition-all cursor-pointer ${
                                                    isSelected
                    ...
                    <div className="pt-6 border-t border-surface-lighter flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            {currentStep > 1 && (
                                <button 
                                    onClick={handleBack}
                                    className="h-10 px-4 text-brand/40 hover:text-brand text-[10px] font-bold uppercase tracking-widest transition-all cursor-pointer"
                                >
                                    Back
                                </button>
                            )}
                            <Button
                                ...
                                className="h-10 px-6 bg-brand text-surface hover:bg-brand/90 transition-all rounded-md font-bold text-[10px] uppercase tracking-widest group disabled:opacity-30 shadow-none cursor-pointer"
                            >
                                {isProcessing ? (
