    ...
    return (
        <div className="min-h-screen bg-surface flex flex-col items-center justify-center p-6">
            <div className="flex flex-col items-center max-w-[320px] w-full text-center">
                <div className="mb-8">
                    <h1 className="text-[64px] font-bold text-foreground/60 tracking-tighter leading-none select-none">
                        403
                    </h1>
                </div>
                ...
                <div className="space-y-2 mb-10">
                    ...
                    <p className="text-[13px] font-medium text-foreground/60 leading-relaxed">
                        You do not have the required permissions to access this coordinate.
                    </p>
                </div>
                ...
                <div className="mt-20 pt-10 border-t border-surface-light w-full flex items-center justify-center gap-6 text-[9px] text-foreground/60 uppercase tracking-widest font-bold">
