...
CREATE TABLE `__new_customization` (
	...
	`site_name` text DEFAULT 'Trident Cloud' NOT NULL,
	...
	`foreground` text DEFAULT '#18181b' NOT NULL,
	`foreground_dark` text DEFAULT '#ffffff' NOT NULL,
...
INSERT INTO `__new_customization`("id", "site_name", "logo_url", "brand_color", "brand_color_dark", "brand_hover", "brand_hover_dark", "surface", "surface_dark", "surface_light", "surface_light_dark", "surface_highlight", "surface_highlight_dark", "surface_lighter", "surface_lighter_dark", "muted_foreground", "muted_foreground_dark", "foreground", "foreground_dark", "border_color", "border_color_dark", "border_radius", "font_family", "is_compact", "is_dark", "updated_at") SELECT "id", "site_name", "logo_url", "brand_color", "brand_color_dark", "brand_hover", "brand_hover_dark", "surface", "surface_dark", "surface_light", "surface_light_dark", "surface_highlight", "surface_highlight_dark", "surface_lighter", "surface_lighter_dark", "muted_foreground", "muted_foreground_dark", "foreground", "foreground_dark", "border_color", "border_color_dark", "border_radius", "font_family", "is_compact", "is_dark", "updated_at" FROM `customization`;--> statement-breakpoint
